...
/**
 * Construct a new RandomMovementDecisionBehavior by taking a delegate. It implements the decorator pattern.
 * @param delegate a Behavior that will make decisions and choose an action using this object's decisions.
 */
