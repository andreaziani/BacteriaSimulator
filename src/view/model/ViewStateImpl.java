...
public class ViewStateImpl implements ViewState {
     ...
     * @param bacteriaState state of bacteria present in simulation.
     */
    public ViewStateImpl(final Map<ViewPosition, ViewFood> foodsState, final Map<ViewPosition, ViewBacteria> bacteriaState) {
